...
public class Peer {
	...
	public static void Monitor_file(String path, procedure peerfunction){
		...
		// Use ListenerThread to auto update register file
		new ListenerThread(path,peerfunction);
	}
	...
	public void download(String fileName, procedure peerfunction){
		...
		new DownloadThread(serverPort,fileName);
...
class ListenerThread extends Thread {
	...
	public ListenerThread(String path,procedure peerfunction){
		this.path = path;
